...
import 'package:ordoapp/src/components/loadings/loading.dart';
...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    print(controller.mahasiswaModels.length);
    return Stack(
      children: [
        Scaffold(
          ...
          body: ListView(
            children: [
                              ...
                              child: CarouselSlider.builder(
                                ...
                                itemBuilder: (BuildContext context,
                                  ...
                                  child: itemsData(context,
                                      ...
                                      title: controller.menuModels.value!
                                      ...
                                      value: controller.menuModels.value!
                              ...
                              children: [
                                DotsIndicator(
                                  ...
                                  dotsCount: controller
                                      .menuModels.value!.result.length,
              ...
              Obx(
                () => controller.isLoading.value == true
                    ...
                    : controller.recentModels.value != null
                        ? ListView.separated(
                            itemCount:
                                controller.recentModels.value!.result.length,
                            shrinkWrap: true,
                            padding: const EdgeInsets.only(
                                left: 15, right: 15, top: 3, bottom: 3),
                            physics: const ScrollPhysics(),
                            scrollDirection: Axis.vertical,
                            itemBuilder: (context, index) => listTilePerson(
                                context,
              ...
              Obx(
                () => controller.mahasiswaModels.isNotEmpty
                    ? ListView.separated(
                        itemCount: controller.mahasiswaModels.length,
                        shrinkWrap: true,
                        padding: const EdgeInsets.only(
                            left: 15, right: 15, top: 3, bottom: 3),
                        physics: const ScrollPhysics(),
                        ...
                        itemBuilder: (context, index) =>
                          ...
                          context,
                          deals: controller.mahasiswaModels[index].mhsNim,
                          index: index + 1,
                          name: controller.mahasiswaModels[index].mhsNama,
                          time: controller.mahasiswaModels[index].mhsProdi
                              .toString(),
        ...
        Obx(() => controller.isLoadingAPI.value == true
            ? floatingLoading()
            : const SizedBox()),
      ],
    );
